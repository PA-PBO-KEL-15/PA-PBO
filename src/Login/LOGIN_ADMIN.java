...
public class LOGIN_ADMIN extends javax.swing.JFrame {
    ...
    public static String idLoginAdmin;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CGY");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, -1, 70));
        ...
        jPanel1.add(txtpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 230, 30));
        ...
        jPanel1.add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 230, 33));
        ...
        jPanel1.add(Login_Admin, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 240, -1, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Password :");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, 80, 20));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Id Admin :");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 80, 20));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FOTO/FOTO GUI/awal.png"))); // NOI18N
    ...
    private void Login_AdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Login_AdminActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                if (txtid.getText().equals(rs.getString("Id_Admin"))
                    && new String(txtpass.getPassword()).equals(rs.getString("Password"))) {
                    JOptionPane.showMessageDialog(null, "login berhasil");
                    this.setVisible(false);
                    new MENU_ADMIN().setVisible(true);
                    
                    LOGIN_ADMIN.idLoginAdmin = rs.getString("Id_Admin");
                }
            }else {
